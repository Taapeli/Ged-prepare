...
"""
Compare family of the person of the userid given with 
family of the person of Taapeli user in Neo4j database.
    ...
    try:
        ...
        for record in result:
            ...
            for trecord in tresult:
                ...
                call_string = "python3 compare_families_with_two_handles_given.py " + p.handle + " " + tp.handle
...
def main():
    parser = argparse.ArgumentParser(description='Compare family of the user with family of Taapeli user in Neo4j database.')
